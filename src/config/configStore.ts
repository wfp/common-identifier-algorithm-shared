...
export class ConfigStore {
    ...
    getRegion() { return this.configPaths.region; }

    // Returns the path of the user config file
    getConfigFilePath() { return this.configPaths.configFilePath; }

    // Returns the path of the backup config file
    getBackupConfigFilePath() { return this.configPaths.backupConfigFilePath; }


    // Returns the path of the application config file
    getAppConfigFilePath() { return this.configPaths.appConfigFilePath; }
